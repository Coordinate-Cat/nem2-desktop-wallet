...
import {MultisigWallet, mockNetworkCurrency, MultisigAccount} from '@MOCKS/conf'
import {NamespaceRegistrationTransaction, Deadline, UInt64, NetworkType, TransferTransaction, Address, PlainMessage, NetworkCurrencyMosaic, MosaicId, NamespaceId, MosaicAliasTransaction, AliasAction, AggregateTransaction} from 'nem2-sdk'
import {FormattedTransaction, FormattedRegisterNamespace, FormattedTransfer, FormattedMosaicAlias, TransactionCategories, TransactionStatusGroups} from '@/core/model'
